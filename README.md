...
If you're looking to download the hacky versions to improve the way the Italics styles work in Kitty, look in the `SeriousShanns/NFMonoRIBBI` folder or the archive in `SeriousShanns/SeriousShannsPatch.zip`
